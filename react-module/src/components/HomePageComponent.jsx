...
class HomePageComponent extends React.Component {
    ...
    loginUser ( event ) {
        ...
        UserService.loginUser(user).then( ( res ) => console.log( res ) )
                            ...
                            <div className="card shadow-lg col-md-8 offset-2 px-5 pt-3">
                                <main className="form-signin">
                                    <form>
                                        ...
                                        <button className="w-100 btn btn-lg btn-dark" type="submit" onSubmit={this.loginUser}>Sign in</button>
                                        <div className="text-center text-muted mt-3">
                                            New user? <Link to="/register" className="nav-link text-dark">Register</Link>
                                        </div>
