...
class UserService {
    ...
    updateUser ( user ) {
        console.log( 'updateUser method call : ' + JSON.stringify( user ) );
...
loginUser( user ) {
    console.log( 'loginUser called for username : ' + user.fname );
...
getUserByUsername( username ) {
    console.log( 'getUserByUsername called for username : ' + username );
...
getUserById( id ) {
    console.log( 'getUserById called for user id : ' + id );
